...
```bash
# Backend tests (pytest, 1567 tests — 100% coverage across all 107 app source files)
cd backend
pip install -r requirements.txt
pytest                         # All tests
...
2. **backend-lint-and-test** — pytest (1567 tests, 100% coverage) with PostgreSQL service + mock Ollama server
