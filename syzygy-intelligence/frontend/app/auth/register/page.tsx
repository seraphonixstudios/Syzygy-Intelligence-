  ...
  return (
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-gradient-to-br from-syzygy-obsidian via-syzygy-shadow to-syzygy-obsidian px-4">
      ...
      <div className="relative w-full max-w-lg py-12 md:py-28">
        ...
        <div className="absolute bottom-[30px] left-[calc(50%-156px)] -translate-x-1/2 hidden md:block">
        ...
        <div className="absolute bottom-[30px] right-[calc(50%-156px)] translate-x-1/2 hidden md:block">
          ...
          <div className="relative bg-syzygy-shadow/90 px-5 py-6 backdrop-blur-xl rounded-2xl md:px-8 md:pb-8 md:pt-8">
            ...
            <div className="relative my-5">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-syzygy-surface-border/50" />
              </div>
              <div className="relative flex justify-center text-xs">
                <span className="bg-syzygy-shadow/90 px-2 text-syzygy-grey/40">or continue with</span>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-syzygy-surface-border bg-syzygy-obsidian/50 px-3 py-2 text-xs text-syzygy-grey/70 transition-all duration-300 hover:border-syzygy-gold/30 hover:text-syzygy-gold"
              >
